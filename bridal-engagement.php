<?php
$page_title = 'Bridal and Engagement Page';
$matatag_description = '';
include('header.php');
?>
<div class="content" style="width:700px;">
  <table id="table_format" width="100%" border="0" cellspacing="2" cellpadding="2" style="font-size:14px">
			<tr>
				<td colspan="2"><strong>Bridal &amp; Engagement</strong></td>
			</tr>
			<tr>
				<td align="center">
						<img src="images/gold-engagement-ring.jpg" alt="" height="138" width="189" border="0" />
				</td>
                <td>
