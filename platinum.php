...
<div class="content" style="width:700px;">
  <table id="table_format" width="100%" border="0" cellspacing="2" cellpadding="2" style="font-size:14px">
			<tr>
				<td colspan="2"><strong style="font-size:24px">Platinum</strong></td>
			</tr>
			<tr>
				<td align="center">
						<img src="images/Platinum-Bracelet.jpg" alt="" height="151" width="219" border="0" />
				</td>
                <td>
