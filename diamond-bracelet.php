<?php
$page_title = 'Diamond Bracelet Page';
$matatag_description = '';
include('header.php');
?>
<div class="content" style="width:700px;">
  <table id="table_format" width="100%" border="0" cellspacing="2" cellpadding="2" style="font-size:14px">
			<tr>
				<td colspan="2"><strong style="font-size:24px">Diamond Bracelet</strong></td>
			</tr>
			<tr>
				<td align="center">
						<img src="images/diamond-bracelet.jpg" alt="" height="218" width="218" border="0" />
				</td>
                <td>
